...
import { checkIfGuestEmailsAreValid } from './emailValidation';
...
export class LivestreamComponent implements OnInit {
  ...
  options: string[] = [
    ...
    , "16:00", "16:15", "16:30", "16:45", "17:00", "17:15", "17:30", "17:45", "18:00", "18:15", "18:30", "18:45", "19:00", "19:15"
  ...
  ngOnInit() {
    ...
    this.liveStream.controls['guests'].valueChanges.subscribe((guestEmails) => {
  ...
  liveStream = this.fb.group({
    ...
    guests: ['', [Validators.required, checkIfGuestEmailsAreValid]]
  ...
  get guests() { return this.liveStream.get("guests") }
  onSubmit() {
